...
class Graph:
    ...
    def bft(self, starting_vertex):
        ...
        while queue.size() > 0:
            ...
            if current_node not in visited:
                # if not, mark as visited and get its neighbors
    ...
    def dft(self, starting_vertex):
        ...
        # if our stack not empty, we have more people to visit
        while stack.size() > 0:
            # get the next node out of line
            ...
            if current_node not in visited:
                ...
                print(current_node)
                edges = self.get_neighbors(current_node)
                # stack them on top of the stack to be visited
                for edge in edges:
                    stack.push(edge)
